...
public class SimpleTests {
	public static void main(String args[]) {
		...
		System.out.println("The lizard has " + liz.getSegments().size() + " segments, expected 3."); // PASSED

		BodySegment headSegment = liz.getHeadSegment();
		Cell headCell = headSegment.getCell();
		System.out.println("The head segment is at " + headCell + ", expected (2,2,Ground,Lizard)."); // PASSED

		BodySegment tailSegment = liz.getTailSegment();
		Cell tailCell = tailSegment.getCell();
		System.out.println("The tail segment is at " + tailCell + ", expected (1,1,Ground,Lizard)."); // PASSED

		BodySegment middleSegment = liz.getSegmentAt(cell1);
		Cell middleCell = middleSegment.getCell();
		System.out.println("The middle segment is at " + middleCell + ", expected (2,1,Ground,Lizard)."); // PASSED

		BodySegment aheadSegment = liz.getSegmentAhead(middleSegment);
		Cell aheadCell = aheadSegment.getCell();
		System.out.println("The segment ahead of the middle is at " + aheadCell + ", expected (2,2,Ground,Lizard)."); // PASSED

		BodySegment behindSegment = liz.getSegmentBehind(middleSegment);
		Cell behindCell = behindSegment.getCell();
		System.out.println("The segment behind the middle is at " + behindCell + ", expected (1,1,Ground,Lizard)."); // PASSED
		...
		System.out.println("The head is pointing " + headDir + ", expected DOWN."); // PASSED

		Direction tailDir = liz.getTailDirection();
		System.out.println("The tail is pointing " + tailDir + ", expected LEFT."); // PASSED
