...
# This is Version 3.0, a version of the bot that (in theory) functions for the currently live version of Wordle.
...
# UPDATES FROM 2.2:
# (1) New function "getDatabase()": gets the file name for the database that should be used
# (2) Added wordFile.close() to getWordList in order to increase performance
...
def greeting(): # Greets the user
    print()
    print("## Hello user. This is Wordle Solver version 3.0. Let's get solving! ##")
...
def getDatabase():
    ...
    try:
        wordList = getWordList(fileName, "r")
    except:
