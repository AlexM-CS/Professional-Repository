...
# This is Version 3.2, a version of the bot that (in theory) functions for the currently live version of Wordle.
...
# UPDATES FROM 3.1:
# (1) Used the random module to create different possible dialogue options for the bot
# No functional purpose, just makes it a bit nicer to read and not so robotic.
# (2) Fixed some typos in various print() statements
...
def greeting(): # Greets the user
    print()
    print("## Hello user. This is Wordle Solver version 3.2. Let's get solving! ##")
