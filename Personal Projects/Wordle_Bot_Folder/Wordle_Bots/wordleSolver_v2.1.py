...
# This is Version 2.1, a more intelligent algorithm that uses additional logic to
...
# UPDATES FROM 2.0:
# (1) New function "createFrequencyDict()": creates a dictionary containing every letter and the frequency with which it appears
# This function was added in an attempt to help get rid of some of the "magic numbers" in the program.
# Additionally, this allows the bot to use any database of words and have a completely accurate description of letter frequency,
# instead of simply using general letter frequency from the entire English language.
# As a side effect, the meaning of a word's score changes from past iterations. Now, instead of a high score
# simply meaning that the letters represent higher sum letter frequency, a higher score represents a better
# chance of the proposed guess of being correct.
...
def greeting(): # Greets the user
    print()
    print("## Hello user. This is Wordle Solver version 2.1. Let's get solving! ##")
